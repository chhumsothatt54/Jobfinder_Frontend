  ...
  <div class="min-h-screen bg-slate-50">
    ...
    <div class="mx-auto max-w-6xl px-6 py-8">
        ...
        >
          <div class="flex items-center gap-4 p-5">
            <img
              :src="company.image"
              :alt="company.name"
              class="h-14 w-14 flex-shrink-0 rounded-lg object-cover ring-2 ring-slate-100"
            />
            <div class="min-w-0">
      ...
      >
        ...
        <p class="mt-3 text-sm font-medium text-slate-700">No companies found</p>
...
const companies = ref([
  {
    ...
    image: 'https://api.dicebear.com/7.x/initials/svg?seed=Northwind%20Traders',
  },
  {
    id: 2,
    name: 'Hana Robotics',
    email: 'hello@hanarobotics.co',
    location: 'Seoul, South Korea',
    image: 'https://api.dicebear.com/7.x/initials/svg?seed=Hana%20Robotics',
  },
  {
    id: 3,
    name: 'Lagos Fintech Group',
    email: 'info@lagosfintech.ng',
    location: 'Lagos, Nigeria',
    image: 'https://api.dicebear.com/7.x/initials/svg?seed=Lagos%20Fintech',
  },
  {
    id: 4,
    name: 'Mekong Logistics',
    email: 'support@mekonglogistics.vn',
    location: 'Ho Chi Minh City, Vietnam',
    image: 'https://api.dicebear.com/7.x/initials/svg?seed=Mekong%20Logistics',
  },
  {
    id: 5,
    name: 'Rossi Design Studio',
    email: 'studio@rossidesign.it',
    location: 'Milan, Italy',
    image: 'https://api.dicebear.com/7.x/initials/svg?seed=Rossi%20Design',
  },
  {
    id: 6,
    name: 'Marina Bay Analytics',
    email: 'team@marinabayanalytics.sg',
    location: 'Singapore',
    image: 'https://api.dicebear.com/7.x/initials/svg?seed=Marina%20Bay',
  },
])
...
function viewCompany(company) {
  // Hook up to your router, e.g. router.push(`/companies/${company.id}`)
